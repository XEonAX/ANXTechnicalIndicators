  ...
  constructor(input: KSTInput) {
    ...
    this.generator = (function* (): IterableIterator<KSTOutput | undefined> {
      ...
      while (true) {
        ...
        RCMA1 =
          roc1Result !== undefined ? sma1.nextValue(roc1Result) : undefined;
        RCMA2 =
          roc2Result !== undefined ? sma2.nextValue(roc2Result) : undefined;
        RCMA3 =
          roc3Result !== undefined ? sma3.nextValue(roc3Result) : undefined;
        RCMA4 =
          roc4Result !== undefined ? sma4.nextValue(roc4Result) : undefined;
