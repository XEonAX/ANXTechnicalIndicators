...
export async function hasDoubleBottom(
  input: PatternDetectorInput,
): Promise<Boolean> {
...
export async function hasDoubleTop(
  input: PatternDetectorInput,
): Promise<Boolean> {
  var result = await predictPattern(input);
...
export async function hasHeadAndShoulder(
  input: PatternDetectorInput,
): Promise<Boolean> {
  var result = await predictPattern(input);
...
export async function hasInverseHeadAndShoulder(
  input: PatternDetectorInput,
): Promise<Boolean> {
  var result = await predictPattern(input);
...
export async function isTrendingUp(
  input: PatternDetectorInput,
): Promise<Boolean> {
  var result = await predictPattern(input);
...
export async function isTrendingDown(
  input: PatternDetectorInput,
): Promise<Boolean> {
  var result = await predictPattern(input);
